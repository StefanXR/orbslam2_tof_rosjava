...
public:
    ...
    void TrackMonoToF(const cv::Mat &im, const cv::Mat &depthmap, const double &timestamp);

    void TrackTOF(const cv::Mat &im, const cv::Mat &depthmap, const double &timestamp);
